...
from grpc.src.python.grpcio_testing.grpc_testing import channel
import raft_pb2
...
def startNode():
	...
	raft_pb2_grpc.add_RaftServicer_to_server(RaftNode(1,"127.0.0.1", 50054, NodeType.FOLLOWER), server)
